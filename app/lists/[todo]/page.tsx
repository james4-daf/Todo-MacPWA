...
import {Loader2, NotepadText, Pencil, Square, SquareCheckBig, X} from "lucide-react";
...
export default function TodoPage() {
    ...
    const [_, setUserLists] = useAtom(todoListsAtom);
    ...
    const handleDeleteList = (key: string) => {
        if (confirm(`Are you sure you want to delete "${unslugify(key)}"?`)) {
    ...
    return (
        <div className="p-12">
            <div className='flex'>
                ...
                <h1 className="text-2xl font-bold mb-4 pr-18">{displayTitle}</h1>
                    ...
                    <div key={idx}>
                        <li
                            ...
                            className={`flex items-center py-3 px-2 space-x-2 rounded cursor-pointer ${
                                todo.completed ? "bg-gray-100 text-gray-500" : "hover:bg-gray-50"
                            }`}
                        >
